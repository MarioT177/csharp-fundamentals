...
/* Defualt Constructor*/
  public Lesson6()
    ...
    /*
     The in parameter modifier is passed by reference. The arguement can be
    not be modified as it is readonly
     */
    public void InExample(in int value)
    {
        // value = 23; // cant change the value
        int total = value + 5;
        Console.WriteLine($"in value + 5 = {total}");
    }

    /*
     The ref parameter modifer is passed by refernce. The value changed
    in the method affets the called variable.
     */
    ...
    /*
     The out parameter modifier is passed by refernce. The out variable
