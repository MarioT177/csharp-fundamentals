...

{
    ...
    /*
     Protected access modifier can only be seen within the type or child
    (derived) class.
     */
    protected void SampledProtected()
    {
        Console.WriteLine("This method is protected.");
    }
    /*
     Internal access modifier can be seen within the assemly, not other assemblies
     */
    ...
    /*
     Private protected can be seen only within the class and child(derived) class from
    within the assembly
     */
