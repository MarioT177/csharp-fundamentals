...
internal class Lesson17
{
    ...
    // Try/catch/Finally blocks used to evaulate an array and parsing
    public void MyArrayException()
    {
        ...
        {
            Console.WriteLine($"Please provide at least 1 arguement: {ex.Message}");
        ...
        {
            Console.WriteLine($"You have given more than a byte: {oe.Message}");
