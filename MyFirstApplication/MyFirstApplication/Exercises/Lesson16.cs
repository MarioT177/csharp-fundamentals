...
{
    /*
     The List<T> is the same as an ArrayList, but we define our type in it 
    declaration as all items are of the same type
     */
    public void MyListExample()
    {
        ...
        // Get or sets the total numer of elements
